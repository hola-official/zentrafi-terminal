  ...
  return (
    <div className="min-h-screen bg-[#060910] text-white relative overflow-x-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-10 flex flex-col gap-10">
        ...
        {/* ── Footer ─────────────────────────────────────────────────────────── */}
        <footer className="pt-8 pb-4 text-center flex flex-col items-center gap-4" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          ...
          <a
            ...
            style={{
              background: "rgba(151,203,220,0.08)",
              border: "1px solid rgba(151,203,220,0.25)",
              color: "#97CBDC",
            }}>
